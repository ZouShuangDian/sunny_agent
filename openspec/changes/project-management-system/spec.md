...
- ✅ **FR-006c**: System MUST support whitelist file types: PDF, Word (.doc/.docx), Excel (.xls/.xlsx), PowerPoint (.ppt/.pptx), Markdown (.md), Text (.txt), Images (.jpg/.png/.gif/.webp)
- ✅ **FR-006d**: System MUST limit file upload to maximum 50MB per file
...
| Max file size | 50 MB | 单个文件最大上传大小 |
| Allowed file types | Whitelist | 白名单模式（PDF/Office/图片/文本/Markdown） |
